...
public class Player extends Actor {
	...
	public Player(String name, float x, float y, float width, float height, Direction heading, SpriteSheet spritesheet) {
		...
		animatePlayerNorth = new Animation(north, 200);
		animatePlayerEast = new Animation(east, 200);
		animatePlayerSouth = new Animation(south, 200);
		animatePlayerWest = new Animation(west, 200);
